...
export function JournalEntryCenter({ companyId, companyName, locationId, locationName, currency, exchangeRates, accounts, onPosted, onOpenSource, onRevaluation }: { companyId: number; companyName: string; locationId: number; locationName: string; currency: string; exchangeRates: { currencyCode: string; rate: number }[]; accounts: Account[]; onPosted: () => Promise<void>; onOpenSource: (id: number) => void; onRevaluation: () => void }) {
