...
const navGroups = [
  ...
  { label: "CUSTOMERS", items: [
    ...
    { id: "warranties", label: "Warranty Slips", icon: ShieldCheck },
  ] },
  { label: "VENDORS", items: [
...
const viewTitles: Record<View, { title: string; sub: string }> = {
  ...
  warranties: { title: "Warranty Slips", sub: "Customer warranties, invoice items and A4 service records" },
...
function WorkflowHome({ onNavigate, onWorkflow }: { onNavigate: (view: View) => void; onWorkflow: (type: string, target: View) => void }) {
  ...
  const customerActions: OverviewWorkflowAction[] = [
    ...
    { label: "Warranty Slips", detail: "Receive items for warranty service", icon: ShieldCheck, view: "warranties" },
