...
export function InvoicePackingListDialog({ open, onOpenChange, companyId, companyName, invoiceId, initialView = "packing" }: { open: boolean; onOpenChange: (open: boolean) => void; companyId: number; companyName: string; invoiceId: number; initialView?: "packing" | "hs-summary" }) {
