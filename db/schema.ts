...
export const companies = pgTable("companies", {
  ...
  loginBackgroundColor: text("login_background_color").notNull().default("#020617"),
...
export const items = pgTable("items", {
  ...
  itemType: text("item_type").notNull().default("stock-part"),
  ...
  purchaseVatCode: text("purchase_vat_code").notNull().default("STANDARD"),
  cogsAccountId: integer("cogs_account_id"),
  preferredSupplierId: integer("preferred_supplier_id"),
  salesVatCode: text("sales_vat_code").notNull().default("STANDARD"),
  incomeAccountId: integer("income_account_id"),
  assetAccountId: integer("asset_account_id"),
  amountsIncludeVat: boolean("amounts_include_vat").notNull().default(false),
...
export const purchaseReceiptAllocations = pgTable("purchase_receipt_allocations", {
  id: serial("id").primaryKey(),
  receiptId: integer("receipt_id").notNull().references(() => transactions.id, { onDelete: "cascade" }),
