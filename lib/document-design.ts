...
export const templateDocumentTypes = ['Invoice','Credit Note','Refund','Sales Receipt','Purchase Order','Purchase Return','Statement','Estimate','Sales Order','Delivery Note','Packing List','Proforma Invoice','Payment Receipt','Paid To','Warranty Received'] as const;
